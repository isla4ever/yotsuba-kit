  ...
  '/components/': [
    {
      ...
      items: [
        ...
        { text: '配置项（Props）', link: '/components/schedule#配置项-props' },
        { text: '事件', link: '/components/schedule#事件' },
        { text: '方法', link: '/components/schedule#方法' },
        { text: '插槽', link: '/components/schedule#插槽' },
        { text: '编辑模式', link: '/components/schedule#编辑模式' },
        { text: '日计划', link: '/components/schedule#日计划' },
        { text: '自定义背景', link: '/components/schedule#自定义背景' },
        { text: '天气、详情与弹层', link: '/components/schedule#天气、详情与弹层' },
      ],
    },
    {
      text: 'Today 今日视图',
